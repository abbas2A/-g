...
send(msg.chat_id_, msg.id_, 1, '⚠┇عذرا لا يمكن تشغيل {'..name_t[2]..'.lua} \n❗┇لانه لا يدعم سورس ساسكي \n 🦁┇[ملفات يدعمها سورس ساسكي](t.me/SNIEBRTEAM)', 1, 'md')
end
else
send(msg.chat_id_, msg.id_, 1, '⚠┇عذرا لا يمكن تشغيل {'..name_t[2]..'.lua} \n❗┇لانه لا يدعم سورس ساسكي \n 🦁┇[ملفات يدعمها سورس ساسكي](t.me/SNIEBRTEAM)', 1, 'md')
end
...
send(msg.chat_id_, msg.id_, 1, '📌┇ تم حذف اسم البوت', 1, 'html')
end
...
🌝┇[قناه السورس](t.me/GASA21)

🔎┇[بوت تحويل صيغ 🎶](http://t.me/SSE5bot)
🔎┇[بوت زخرفه 💗](http://t.me/GASA21bot)

📮┇[لـ تواصل 💌 ،](http://t.me/ANKJLbot)

🌝┇[تابع قناة البوت](http://t.me/GASA21)
]]
send(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end
------------------------------------------------------------------------
